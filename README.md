...
## Features
* Notes can be saved in plain text or html-formatted with embedded images
* Notes can be viewed in app or click on the note title and they open in a tab in your browser
* Customizable theme
...
NOTE: The script will also install the necessary Hearth framework, but if you point it to a directory where it already exists then it will give you the option to just install/update xnote.
...
## App Pics
[![View App Pics](https://img.shields.io/badge/App-Pics-blue)](https://karmahelen.github.io/xnote/AppPics.html)
...
xnote.helpless770@passinbox.com
